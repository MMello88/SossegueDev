...
class ArCondicionadoInstalacao extends MY_Front {
    ...
    public function ribeirao_preto() {
        ...
        //$this->data['estados'] = $this->superModel->select('estado');
            ...
            $this->layout->view('instalacao_arcondicionado', $this->data);
        }
    ...
    private function enviaEmailPedido() {
