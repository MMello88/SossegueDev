...
class Sitemap extends CI_Controller {
	...
	public function __construct() {
		...
		$this->articles = array(
			...
			array(
				'loc' => base_url('termos_e_condicoes'),
				//'lastmod' => date('Y-m-d', time()),
				'changefreq' => 'weekly',
				'priority' => 0.8
			),
	...
	public function index() {
		...
		$this->sitemapmodel->add(base_url('sitemap/quem_somos'), date('Y-m-d', time()));
		$this->sitemapmodel->add(base_url('sitemap/faq'), date('Y-m-d', time()));
		$this->sitemapmodel->add(base_url('sitemap/termos_e_condicoes'), date('Y-m-d', time()));
