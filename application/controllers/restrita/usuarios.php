...
class Usuarios extends MY_Restrita {
    ...
    public function listar() {
        $clausulas = array(
            'select' => 'id_usuario, usuario.status, nome, email',
            'condicoes' => array(
                array(
                    'campo' => 'usuario.status',
                    'sinal' => '<>',
    ...
    public function editar($id) {
        ...
        $clausulas = array(
            'row' => true,
            'select' => 'usuario.id_usuario, nome, email, cpf, DATE_FORMAT(nascimento, "%d/%m/%Y") AS nascimento, telefone, celular, id_cidade, bairro, endereco, numero, complemento, id_usuario_endereco',
            'condicoes' => array(
                array(
                    'campo' => 'usuario.id_usuario',
                    'valor' => $id
