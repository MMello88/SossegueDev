...
class PagSeguroConfigWrapper
{
     ...
     *
     */
    const PAGSEGURO_EMAIL = "contato.sossegue@gmail.com";
    /**
     *
     */
    const PAGSEGURO_TOKEN_PRODUCTION = "A04D1468399F4CA5A35FFA21775FE852";
    /**
     *
     */
    const PAGSEGURO_TOKEN_SANDBOX = "697A5F580A094FBA915C6861612A5C75";
    /**
     *
     */
    const PAGSEGURO_APP_ID_PRODUCTION = "Sossegue";
    /**
     *
     */
    const PAGSEGURO_APP_ID_SANDBOX = "app7601354701";
    /**
     *
     */
    const PAGSEGURO_APP_KEY_PRODUCTION = "93AC5FBA77777EF444914FA3ED437FDE";
    /**
     *
     */
    const PAGSEGURO_APP_KEY_SANDBOX = "05F3BA9BE5E5251DD4259FAFD6AF5F2D";
    /**
     * UTF-8, ISO-8859-1
     */
    ...
    {
        $PagSeguroConfig['environment'] = getenv('PAGSEGURO_ENV') ? getenv('PAGSEGURO_ENV') : self::PAGSEGURO_ENV;
    ...
    private static function getApplicationEncoding()
    {
        ...
        $PagSeguroConfig['application']['charset'] = ( getenv('PAGSEGURO_CHARSET')
            ...
            ? ( getenv('PAGSEGURO_CHARSET')
            && ( getenv('PAGSEGURO_CHARSET') == "UTF-8" || getenv('PAGSEGURO_CHARSET') == "ISO-8859-1") ) : self::PAGSEGURO_CHARSET;
