...
<?php echo form_open('restrita/categorias/alterar'); ?>
<div class="col-sm-12">
    <input class="form-control" type="text" placeholder="Nome da categoria" name="categoria" value="<?php echo $categoria->categoria; ?>" required>
</div>
<div class="col-sm-3">
