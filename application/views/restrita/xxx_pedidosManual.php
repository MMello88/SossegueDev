...
<?php if ($pedidos) { ?>
    <div class="col-sm-12"> 
        ...
        <?php } ?>
        <div class="col-sm-12">
            <input class="form-control" type="text" placeholder="Normas (Ex.: NR10/NR15/NR35)" name="normas" id="normas" >
        </div>
        <div class="col-sm-12">
            <input class="form-control" type="text" placeholder="Qualificacoes" name="qualificacoes" id="qualificacoes" >
        </div>
