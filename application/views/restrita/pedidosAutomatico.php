...
<section class="section_mod-d border-top">
                    ...
                    <div class="row" style="padding-bottom:15px;">
                        ...
                        <div class="col-md-4 yamm-scroll" style="padding-left:30px;">
                            <div class="header-contacts">
                                ...
                                <a class="btn btn-success btn-lg Button" style="margin-left:-70px;" href="<?php
                                if ($this->session->userdata('idPedidoOrcamento', 0) != 0) {
                                    echo base_url('restrita/pedidos_orcamentos/alterar/' . $this->session->userdata('idPedidoOrcamento'));
                                } else {
                                    echo base_url('restrita/pedido/pedidoManual/' . $this->session->userdata('url'));
                                }
                                ?>">
                                    <span class="glyphicon-class">Ir para Pedidos de Orçamento(<?php echo $total_pedido->total_pedido;?>)</span>
                                </a>
                                
                                <?php if ($this->session->userdata('nome_sol') == "") {  ?>
                                
                              <a class="btn btn-success btn-lg Button2 " href="<?php echo base_url('restrita/pedidos_orcamentos/cancelar/' . $this->session->userdata('idPedidoOrcamento'));?>">
                                    <span class="glyphicon-class">Cancelar Pedido</span>
                                </a>
                                <?php } ?>   
                        ...
                        <?php foreach ($categoria_servicos as $categoria_servico) { ?>
                            ...
                            <div class="col-sm-5 col-md-4 col-lg-3" style="padding-bottom:30px;">
                                <div class="team-box">
                                    ...
                                    <?php echo form_open('restrita/pedido/actionPedido/' . $this->session->userdata('url'), array('id' => 'formCadastro', 'class' => 'bounceInLeft form-horizontal', 'data-wow-duration' => '1s')); ?>
  ...
  <?php  } ?>
                                    ...
                                    <div>
                                        <button class="header-contacts__info btn_1" id="btn8"  data-loading-text="Verificando os campos" style="margin-left: 21px;" name="submit_type" value="addCart" autocomplete="off">Adicionar Pedido de Orçamento</button>
                                    </div>
                                    <?php echo form_close(); ?>
                                </div>
                            </div>
