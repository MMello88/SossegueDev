                                    ...
                                    <ul class="nav navbar-nav">
                                        <?php foreach ($MenuSubCategorias as $item) { ?>
                                                ...
                                                <?php if ($item->subcategoria == 'Marido de Aluguel') { ?>
                                                    <li><a href="<?php echo base_url('restrita/pedido'. '/' . removeAcentos($item->link)); ?>">FIXAÇÃO </a></li>
                                                <?php } else { ?>
                                                    <li><a href="<?php echo base_url('restrita/pedido' . '/' . removeAcentos($item->link)); ?>"><?php echo $item->subcategoria; ?> </a></li>
                                                <?php } ?>
                                        <?php } ?>
