              ...
              <div class="col-md-3 col-sm-6">
                ...
                <div class="footer__section"> <a class="footer__logo" href="javascript:void(0);"><img src="<?php echo base_url('assets/img/logo_mod-b.png')?>" height="43" width="197" alt="Logo"></a>
                  ...
                  <ul class="social-links">
                    ...
                    <li><a class="icon fa fa-linkedin" href="<?php echo $config['linkedin']; ?>"></a></li>
                    <?php } ?>
                    ...
                    <li><a class="icon fa fa-youtube" href="<?php echo $config['youtube']; ?>"></a></li>
                    <?php } ?>

                    <?php if($config['instagram']) { ?>
                    <li><a class="icon fa fa-instagram" href="<?php echo $config['instagram']; ?>"></a></li>
                    <?php } ?>
              ...
              <div class="col-md-2 col-sm-6">
                ...
                <section class="footer__section">
                  ...
                  <ul class="footer-list list-unstyled">
                    ...
                    <li class="footer-list__item"> <a class="footer-list__link" href="<?php echo base_url('quem-somos');?>" target="_blank">Quem Somos</a> </li>

                    <li class="footer-list__item"> <a class="footer-list__link" href="<?php echo base_url('faq');?>" target="_blank">Perguntas frequentes</a></li>

                    <li class="footer-list__item"> <a class="footer-list__link" href="<?php echo base_url('termos-e-condicoes'); ?>" target="_blank">Termos de Uso Manutenção</a></li>
                ...
                <section class="footer__section">
                  ...
                  <div class="footer-contact"> <i class="icon icon-clock"></i>
                    ...
                    <div class="footer-contact__inner">
                      ...
                      <div class="footer-contact__title">Horario Seg. à Sexta</div>
                  ...
                  <?php if($config['horario_sabado']) { ?>

                    <div class="footer-contact"> <i class="icon icon-clock"></i>

                      <div class="footer-contact__inner">

                        <div class="footer-contact__title">Horario aos Sabádos</div>

                        <div class="footer-contact__info"><?php echo $config['horario_sabado']; ?></div>
