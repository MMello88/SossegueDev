<title>Tenha 3 Orçamentos de Eletricista de Ribeirão Preto | Sossegue</title>
<meta content="Encontre Eletricista confiáveis e qualificados, de forma rápida e prática!" name="description">
      ...
      <div class="container">
        <div class="row">
            <div class="col-md-6 col-md-offset-3 wow bounceInLeft txt-center" data-wow-duration="1s">
                <h1 class="ui-title-block">RECEBA <strong>3 ORÇAMENTOS</strong> DE <strong>ELETRICISTAS DE RIBEIRÃO PRETO</strong></h1>
                <h2>NÃO SE PREOCUPE! SERÃO OS <strong>MELHORES ELETRICISTAS</strong> COM OS <strong>MENORES PREÇOS</strong>!</h2> 
            </div>
          <!-- end col -->
            ...
            <div class="container">
                ...
                <style>
                        ...
                        <div class="section-list-block">
                            <ul class="list-block list-unstyled">
                                    ...
                                    <a class="list-block__link">                                        
                                        ...
                                        <div class="list-block__title"><font size="3">Nos conte por que você precisa de <strong>Eletricista</strong>.</font></div>
                                    ...
                                    <a class="list-block__link">                                        
                                        ...
                                        <div class="list-block__title"><font size="3">Avalie o <strong>Eletricista</strong> contratado.</font></div>
                    ...
                    <div class="col-md-4 col-md-offset-1 margin_g form_cadastro">                        
                        <?php echo form_open('eletricista/ribeirao_preto', array('id' => 'formCadastro', 'class' => 'bounceInLeft form-b', 'data-wow-duration' => '2s')); ?>
                ...
                <div p align="center">
                    <div class="list-block__title" color="#999999"><h2>Por que contratar <u><strong>Eletricista<strong></strong></u> pela <strong>Sossegue</strong>?</h1></div>
                    <div class="list-block__info" color="#999999"><h3>A <strong>Sossegue</strong> irá enviar <em><strong>Eletricista</strong></em> altamente qualificados e que passaram por um rigoroso controle de qualidade. Preencha o formulário acima e, dentro de minutos, você receberá <strong>3 orçamentos diferentes</strong>.</h3></div>
