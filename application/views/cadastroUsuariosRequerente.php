...
<meta name=viewport content="width=device-width, initial-scale=1">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 col-md-offset-3 wow bounceInLeft txt-center" data-wow-duration="1s">
            <h1 class="ui-title-block">Cadastro de Requerente</h1>
          </div>
          <!-- end col -->     
    ...
    <div class="container col-md-4 col-md-offset-8 margin_g form_cadastro">
                        <?php echo form_open('link/salvar/requerente/'.$idEmpresa, array('id' => 'formCadastro', 'class' => 'bounceInLeft form-b', 'data-wow-duration' => '2s')); ?>
