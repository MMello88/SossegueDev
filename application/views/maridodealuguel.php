      ...
      <div class="container">
        <div class="row">
            <div class="col-md-6 col-md-offset-3 wow bounceInLeft txt-center" data-wow-duration="1s">
                <h1 class="ui-title-block"><strong>RECEBA 3 ORÇAMENTOS DE MARIDOS DE ALUGUEL DE RIBEIRÃO PRETO</strong></h1>
                <h2><strong>NÃO SE PREOCUPE! SERÃO OS MELHORES MARIDOS DE ALUGUEL COM OS MENORES PREÇOS!</strong></h2> 
            </div>
          <!-- end col -->
            ...
            <div class="container">
                ...
                <style>
                    ...
                    <div class="col-md-4 col-md-offset-1 margin_g form_cadastro">                        
                        <?php echo form_open('maridodealuguel/ribeirao_preto', array('id' => 'formCadastro', 'class' => 'bounceInLeft form-b', 'data-wow-duration' => '2s')); ?>
                            ...
                            <div class="col-sm-6">
                                <select name="subcategoria" id="subcategoria" class="form-control form-b">
                                    <option value="" class="option_cad"><strong>Marido de Aluguel</strong></option>
                                </select>
                            </div>
							<div class="col-sm-12">
                ...
                <div p align="center">
                    <div class="list-block__title" color="#999999"><h2>Por que contratar <u><strong>Marido de Aluguel</strong></u> pela Sossegue?</h2></div>
                    <div class="list-block__info" color="#999999"><h3>A Sossegue irá enviar <em><strong>Maridos de Aluguel</strong></em> altamente qualificados e que passaram por um rigoroso controle de qualidade. Preencha o formulário acima e, dentro de minutos, você receberá 3 orçamentos diferentes.</h3></div>
