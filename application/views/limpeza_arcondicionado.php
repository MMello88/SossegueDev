<title>Tenha 3 Orçamentos de Limpeza de Ar Condicionado em Ribeirão Preto | Sossegue</title>
<meta content="Encontre Limpeza de Ar Condicionado confiáveis e qualificados, de forma rápida e prática!" name="description">
      ...
      <div class="container">
        <div class="row">
            <div class="col-md-6 col-md-offset-3 wow bounceInLeft txt-center" data-wow-duration="1s">
                <h1 class="ui-title-block">RECEBA <strong>3 ORÇAMENTOS</strong> DE <strong>LIMPEZA DE AR CONDICIONADO EM RIBEIRÃO PRETO</strong></h1>
                        ...
                        <div class="section-list-block">
                            <ul class="list-block list-unstyled">
                                    ...
                                    <a class="list-block__link">                                        
                                        ...
                                        <div class="list-block__title"><font size="3">Nos conte por que você precisa de <strong>Limpeza de Ar Condicionado</strong>.</font></div>
                        ...
                        <?php echo form_open('ArCondicionadoInstalacao/ribeirao_preto', array('id' => 'formCadastro', 'class' => 'bounceInLeft form-b', 'data-wow-duration' => '2s')); ?>
                            ...
                            <div class="col-sm-6">
                                <select name="subcategoria" id="subcategoria" class="form-control form-b">
                                    <option value="175" class="option_cad"><strong>Limpeza de Ar Condicionado</strong></option>
                                </select>
                            </div>
							<div class="col-sm-12">
