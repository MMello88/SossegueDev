<title>Tenha 3 Orçamentos de Instalação de Ar Condicionado em Ribeirão Preto | Sossegue</title>
<meta content="Encontre Instalação de Ar Condicionado confiáveis e qualificados, de forma rápida e prática!" name="description">
      ...
      <div class="container">
        <div class="row">
            <div class="col-md-6 col-md-offset-3 wow bounceInLeft txt-center" data-wow-duration="1s">
                <h1 class="ui-title-block">RECEBA <strong>3 ORÇAMENTOS</strong> DE <strong>INSTALAÇÃO DE AR CONDICIONADO EM RIBEIRÃO PRETO</strong></h1>
            ...
            <div class="container">
                ...
                <style>
                        ...
                        <div class="section-list-block">
                            <ul class="list-block list-unstyled">
                                    ...
                                    <a class="list-block__link">                                        
                                        ...
                                        <div class="list-block__title"><font size="3">Nos conte por que você precisa de <strong>Instalação de Ar Condicionado</strong>.</font></div>
                                    ...
                                    <a class="list-block__link">                                        
                                        ...
                                        <div class="list-block__title"><font size="3">Avalie o <strong>Profissional</strong> contratado.</font></div>
                    ...
                    <div class="col-md-4 col-md-offset-1 margin_g form_cadastro">                        
                        <?php echo form_open('ArCondicionadoInstalacao/ribeirao_preto', array('id' => 'formCadastro', 'class' => 'bounceInLeft form-b', 'data-wow-duration' => '2s')); ?>
                            ...
                            <div class="col-sm-6">
                                <select name="subcategoria" id="subcategoria" class="form-control form-b">
                                    <option value="174" class="option_cad"><strong>Instalação de Ar Condicionado</strong></option>
                                </select>
                            </div>
							<div class="col-sm-12">
                ...
                <div p align="center">
                    <div class="list-block__title" color="#999999"><h2>Por que contratar <u><strong>Instalação de Ar Condicionado<strong></strong></u> pela <strong>Sossegue</strong>?</h1></div>
