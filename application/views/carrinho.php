...
<section class="section_mod-d border-top">
        ...
        <div class="row" style="padding:30px 0px 30px 0px;">
            ...
            <div class="col-md-4" style="padding:0px 30px 0px 30px;">
                <div class="header-contacts">
                    ...
                    <a class="btn btn-danger btn-lg disabled" align="center" id="btn8"  data-loading-text="Finalizando o Pedido" rule="button" href="<?php echo base_url('Carrinho/Finalizar/'.$id_orcamento); ?>">Finalizar o Pedido</a>
                    <?php } else { ?>
                    <a class="Button btn btn-default" align="center" id="btn8"  data-loading-text="Finalizando o Pedido" rule="button" href="<?php echo base_url('Carrinho/Finalizar/'.$id_orcamento); ?>">Finalizar o Pedido</a>
                    <?php } ?>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row" style="padding-left: 15px; padding-right: 15px;">
            ...
            <?php echo form_open('Carrinho/Alterar', array('id' => 'formCadastro', 'data-wow-duration' => '2s')); ?>
            <?php $idNumber += 1; ?>
                    ...
                    <div class="col-xs-12 col-md-2" style="padding-top: 15px;">
                        <div class="form-group">
                            <div class="input-group">
                              ...
                              <input type="text" id="qntd" name="qntd" class="form-control"  placeholder="Qtde" style="text-align: center;" value="<?php echo $pedido->qntd; ?>" maxlength="2" required readonly="true">
    ...
    <div class="container">
        <div class="row" style="padding:0px 15px 15px 15px;">  
            <div class="team-box-cont">
                <h5><a href="<?php echo base_url('Manutencao/'.$url.'/ribeirao_preto/'); ?>"><font color="#333">Adicionar mais serviços</font></a></h5>
            </div>
        </div>
    </div>
